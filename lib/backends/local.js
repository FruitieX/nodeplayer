...
Local.prototype.prepare = function(song, callback) {
    ...
    var filePath = self.songCachePath + '/local/' + song.songId + '.opus';
    ...
    if (self.songsPreparing[song.songId]) {
        ...
        self.songsPreparing[song.songId] = {
            cancel: function() {
                canceled = true;
                if (cancelEncode) {
                    cancelEncode();
        ...
        self.songsPreparing[song.songId] = _.extend(self.songsPreparing[song.songId], song);
...
Local.prototype.cancelPrepare = function(song) {
    // TODO: wat?
    this.songsPreparing.push(song.songId);
};
