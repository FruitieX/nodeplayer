...
var checkDuration = function(song) {
    ...
    if (song.duration > config.songMaxDuration) {
        return '[partyplay] song duration ' + song.duration +
            ' too long, max: ' + config.songMaxDuration;
    }
};
...
exports.sortQueue = function() {
    ...
    player.queue.sort(function(a, b) {
        var aVotes = a.oldness + Object.keys(a.upVotes || {}).length -
            Object.keys(a.downVotes || {}).length;

        var bVotes = b.oldness + Object.keys(b.upVotes || {}).length -
