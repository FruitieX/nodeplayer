...
Player.prototype.init = function() {
  ...
  async.series([
    function(callback) {
      ...
      modules.loadPlugins(player, config.plugins, forceUpdate, function(results) {
...
Player.prototype.clearPrepareTimeout = function(song) {
...
Player.prototype.prepareProgCallback = function(song, bytesWritten, done) {
    /* progress callback
